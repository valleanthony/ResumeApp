...
public class Main {
    public static userGui(){
         ...
         */
            ...
            users.get(0).printPersonInfo();
            users.get(1).printPersonInfo();
    ...
    public static void main(String[] args) {
        ...
        Scanner keymain = new Scanner(System.in);

        System.out.println("Would you like to create a resume?(Y/N)");
        newUser = keymain.nextLine();
